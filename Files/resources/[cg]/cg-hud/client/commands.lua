...
-- Quick demo to verify UI updates: animates circles down and up
RegisterCommand("huddemo", function()
    local vals = { healthBar = 100, armorBar = 0, foodBar = 100, drinkBar = 100, staminaBar = 100, oxygenBar = 100 }
    CreateThread(function()
        ...
        for i=100,0,-5 do
            ...
            vals.staminaBar = i
            vals.oxygenBar = i
            SendNUIMessage({ type = "STATUS_HUD", value = vals })
            Wait(150)
        end
        -- Count up
        for i=0,100,5 do
...
-- Removed noisy huddebug command to prevent F8 spam
